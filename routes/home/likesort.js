        ...
        res.status(400).send({
          message : "null Value"
            ...
            let selectQuery = `SELECT DISTINCT C.contentsIdx, C.contentsTitle, C.contentsInfo, C.contentsHit,C.contentsCategory, C.contentsDate,
                                          C.contentsLike,C.contentsRuntime, C.contentsUrl, C.contentsoriginUrl, C.contentsType, hashName1, hashName2, hashName3, 
                                         ...
                                         FROM Contents as C WHERE C.contentsCategory=?  ORDER BY C.contentsLike DESC limit ?, 12`;
